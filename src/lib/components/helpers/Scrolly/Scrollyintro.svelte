		...
		<div slot="background">
			<div class="background-content">
				...
				<div class = "intro-text" transition:fade>
					<h1 style="text-decoration: line-through;">Lost Shape, Discolored, Broken</h1>
				</div>
				<div class = "intro-text" in:fly ="{{ y: 200, duration: 3000 }}">
					<p>These are the common rookie’s mistakes if you don’t know how to take care of your clothes properly-learning how to wash & care your garment is crucial for a long-life and sustainable fashion consumption. This project aims to demystify garment washing & caring.</p>
				</div>
