...
<div class="scrollyGraphic">
	<Scroller {top} {threshold} {bottom} bind:count bind:index bind:offset bind:progress>
		...
		<div slot="foreground">
			...
			<section>
				<div class="step">
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui fuga ratione iure numquam
					nisi blanditiis optio, minus soluta quaerat esse aliquam exercitationem temporibus autem
					mollitia maxime facilis tempore officiis maiores.
				</div>
			</section>
		</div>
	</Scroller>
